...
function WarningLightsPage() {
  ...
  const warningLightsData = [
    ...
    },
    {
      ...
      detailedDescription: "The battery alert light indicates that the vehicle's battery voltage is low. This could be due to a failing battery, a malfunctioning charging system, or other electrical issues. It's important to address this issue promptly, as a low battery can lead to a no-start condition. Have the battery and charging system inspected by a mechanic.",
      icon: batteryIcon,
    },
    {
      id: 6,
    ...
    },
    {
      ...
      detailedDescription: "The engine temperature warning light signals that the engine's coolant temperature is higher than normal. High engine temperature can lead to overheating and potential engine damage. Safely pull over and allow the engine to cool down. Check the coolant level, radiator, and cooling system for issues. Avoid driving with an overheated engine.",
    ...
    },
    {
      ...
      detailedDescription: "The fog lamp indicator light indicates that the vehicle's fog lamps are turned on. Fog lamps are used to improve visibility in foggy conditions. Make sure to turn off the fog lamps when driving in clear weather, as they can be blinding to other drivers and reduce your own visibility.",
      icon: foglampIcon,
    },
    {
      id: 9,
    ...
    },
    {
      ...
      detailedDescription: "The low fuel warning light indicates that the vehicle's fuel level is low. It's important to refuel soon to avoid running out of fuel. Running the vehicle on a low fuel level can potentially damage the fuel system and lead to a breakdown. Find a gas station and refuel as soon as possible.",
      icon: lowFuelIcon,
    },
    {
      id: 11,
      ...
      detailedDescription: "The seat belt reminder light indicates that one or more occupants in the vehicle haven't fastened their seat belts. Seat belts are critical for passenger safety in the event of a collision. All occupants should fasten their seat belts before the vehicle is in motion. The light will turn off when seat belts are buckled.",
      icon: seatBeltIcon,
    },
    {
      id: 12,
    ...
    },
    {
      ...
      detailedDescription: "The transmission temperature warning light signals that the transmission fluid temperature is higher than normal. Overheating transmission fluid can lead to transmission damage and poor shifting performance. Safely pull over and allow the transmission to cool down. Check the transmission fluid level and ensure proper cooling system function.",
      ...
      {selectedWarning !== null && (
        <div className="warningLights-modal">
          <div className="warningLights__modal--content">
            <h2 className="warningLights__modal--title">{warningLightsData[selectedWarning - 1].title}</h2>
            <p className="warningLights__modal--description">{warningLightsData[selectedWarning - 1].description}</p>
            <p className="warningLights__modal--detailedDescription">{warningLightsData[selectedWarning - 1].detailedDescription}</p>
