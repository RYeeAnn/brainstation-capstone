        ...
        <section className="about">
            ...
            <div className="about__content">
                ...
                <div className="about__text">
                    <h2>About Me</h2>
                    <p>
                        Hello! I'm Ryan, a passionate car enthusiast and DIY mechanic. I have a deep love for cars and a strong desire to help people understand the ins and outs of vehicle maintenance.
                    </p>
                    <p>
